              ...
              <fo:table-body>
                <fo:table-row>
                  ...
                  <fo:table-cell border-style="solid" border-width="1pt"
                                 ...
                                 text-align="start">
                    <fo:block>
                      <xsl:value-of select="MonthlyStats/ReportRegion"/>&#160;<xsl:value-of select="MonthlyStats/ReportSubTitle"/> - <xsl:value-of select="MonthlyStats/ReportMonth"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
...
<!-- TEST OF NEW SECTION 2 -->
			<fo:block font-family="Times">
            <xsl:attribute name="id">OpenCritAndHigh</xsl:attribute>

            <fo:block color="#000000" font-size="16pt" font-weight="bold"> 2.
            Open Critical and High Impact Issues</fo:block>
            ...
            <fo:block margin-left="0pt">
		    	...
		    	<xsl:choose>
		    		<xsl:when test="count(MonthlyStats/Project/OpenIssues/Finding[@Impact = 'Critical'] | MonthlyStats/Project/OpenIssues/Finding[@Impact = 'High']) > 0">
		    		<!--<xsl:for-each select="MonthlyStats/Project/OpenIssues">
						<xsl:sort select="../../../@dateCompleted" order="descending"/>-->
		                <xsl:call-template name="processFindingsCritAndHigh">
		                  <xsl:with-param name="targetData">
		                    <xsl:value-of select="MonthlyStats/Project/OpenIssues" />
		                  </xsl:with-param>                 
		                </xsl:call-template>
					<!--</xsl:for-each>-->
	            	...
	            	<xsl:otherwise>
	            		<fo:block color="#000000" font-size="10pt">No outstanding critical or high impact issues.</fo:block>
	            	</xsl:otherwise>
	            </xsl:choose>
    ...
    <fo:block font-family="Times">
      <fo:block space-before="20pt">
        <fo:external-graphic margin-right="290pt">
          ...
          disable-output-escaping="yes">U:\_AuthenticAndFopFiles\AbnLogo.jpg</xsl:text>')</xsl:attribute>
        </fo:external-graphic>
      </fo:block>
    ...
    <fo:block font-family="Times">
      ...
      <fo:block end-indent="24pt" font-size="14pt" font-weight="bold"
       ...
       <fo:block end-indent="24pt" font-size="11pt" font-weight="normal"
                  ...
                  text-align-last="justify">
          <fo:inline keep-with-next.within-line="always"> <fo:leader
          leader-length="30pt" leader-pattern="space" /> 1.1 All Locations (<xsl:value-of select="MonthlyStats/ReportRegion"/>)
          </fo:inline>
         ...
         <fo:block end-indent="24pt" font-size="11pt" font-weight="normal"
                  ...
                  text-align-last="justify">
          <fo:inline keep-with-next.within-line="always"> <fo:leader
          leader-length="30pt" leader-pattern="space" /> 1.2 By Project
          </fo:inline>
          ...
          <fo:inline keep-together.within-line="always">
            <fo:leader keep-with-next.within-line="always"
                       ...
                       leader-pattern-width="3pt" />
            <fo:page-number-citation>
              <xsl:attribute name="ref-id">1.2. By Project</xsl:attribute>
            </fo:page-number-citation>
          </fo:inline>
        </fo:block>
          ...
          <fo:block end-indent="24pt" font-size="14pt" font-weight="bold"
                last-line-end-indent="-24pt" line-height="20pt"
                space-after="20pt" text-align-last="justify">
        <fo:inline keep-with-next.within-line="always"> 2. Details of Open Critical and High Impact Issues
        </fo:inline>
        ...
        <fo:inline keep-together.within-line="always">
          ...
          <fo:page-number-citation ref-id="OpenCritAndHigh" />
        </fo:inline>
        </fo:block>
      ...
      <fo:block end-indent="24pt" font-size="14pt" font-weight="bold"
                last-line-end-indent="-24pt" line-height="20pt"
                space-after="20pt" text-align-last="justify">
        <fo:inline keep-with-next.within-line="always"> 3. Details of All Outstanding Issues
        </fo:inline>
...
<xsl:call-template name="locSummary">
 <xsl:with-param name="title">1.2. By Project</xsl:with-param>
 <xsl:with-param name="filteredList"><xsl:value-of select="MonthlyStats/Project"/></xsl:with-param>
</xsl:call-template>
...
1.1. All Locations (<xsl:value-of select="MonthlyStats/ReportRegion"/>)
    </fo:block>
<fo:block>
  ...
  <xsl:template name="locSummaryHeader">	
	<fo:table-row text-align="left">
	  <fo:table-cell number-columns-spanned="2" padding="2pt" text-align="left">
        <fo:block font-size="10pt" font-weight="bold"></fo:block>
      </fo:table-cell>
...
<xsl:template name="processFindingsCritAndHigh">
    <xsl:param name="targetData" />
    <xsl:param name="ItemNumber" />
    <fo:block color="#111111" font-size="10pt" margin-right="-20pt"
              space-after="20pt" space-before="10pt">
      <fo:table border-color="black" border-style="solid" border-width="2px"
        ...
        <fo:table-body>
          <xsl:call-template name="printTopOfFindingsTableCritAndHigh" />

          <xsl:for-each select="$targetData/Finding[@Impact = 'Critical'] | $targetData/Finding[@Impact = 'High']">
			<!--<xsl:sort select="$targetData/Finding/@Impact"/>-->
			<xsl:sort select="translate(@Impact, 'CH', '12')"/>
            <xsl:call-template name="processFindingCritAndHigh">
              <xsl:with-param name="findingData">
                <xsl:value-of select="." />
              </xsl:with-param>
            </xsl:call-template>
  ...
  <xsl:template name="processFindingCritAndHigh">
    <xsl:param name="findingData" />
      ...
      <fo:table-row padding="2pt">
		<fo:table-cell border-style="solid" padding="2pt">
          <fo:block color="#111111" font-size="8pt" margin-right="2pt"
          wrap-option="wrap"><xsl:apply-templates
          select="$findingData/../../@name" /></fo:block>
        </fo:table-cell>
  ...
  <xsl:template name="printTopOfFindingsTableCritAndHigh">
    <fo:table-row background-color="#003399" color="#FFFFFF" text-align="left">
      <fo:table-cell border-style="solid" padding="2pt" text-align="left">
        <fo:block font-size="10pt" font-weight="bold">Project</fo:block>
      </fo:table-cell>
