namespace sourceControl.layouts.blank
{
	using System;
	...
	/// </summary>
	public class blank : System.Web.UI.UserControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if("" + Session["userId"]=="")
			{
				panelPlaceHolder.Controls.Add(base.LoadControl("~\\controls\\framework\\signIn.ascx"));
				return;
			}
