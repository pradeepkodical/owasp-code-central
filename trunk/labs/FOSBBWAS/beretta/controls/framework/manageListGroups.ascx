<%@ Control Language="c#" AutoEventWireup="false" Codebehind="manageListGroups.ascx.cs" Inherits="sourceControl.controls.framework.manageListItems" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<br>

<h1>Manage List Groups</h1>
<asp:Panel ID="panelNew" Visible="False" Runat="server">
	<TABLE width="500">
		...
		<TR>
			...
			<TD>
				<asp:TextBox id="txtListGroupName" Runat="server" Width="300"></asp:TextBox></TD>
		</TR>
		<TR>
			<TD>&nbsp;
			</TD>
		...
		<TR>
			...
			<TD>
				...
				<asp:Button id="cmdCancel" Runat="server" Text="Cancel"></asp:Button></TD>
		</TR>
		<TR>
			<TD>&nbsp;
			</TD>
	...
	<asp:datagrid id="dbgrid" runat="server" Width="600" OnItemCommand="dgCommand_onClick" PagerStyle-Mode="NumericPages"
		...
		<Columns>
			...
			<asp:TemplateColumn ItemStyle-Width="100">
				<ItemTemplate>
					<asp:Image BorderWidth="0" Runat="server" ImageUrl="~/common/images/dropDown.gif" ID="Image1"
						NAME="Image1"></asp:Image>
				</ItemTemplate>
			</asp:TemplateColumn>
			<asp:TemplateColumn ItemStyle-Width="250" HeaderText="List Group Name">
				<ItemTemplate>
					&nbsp;
					<asp:linkbutton ID="lblDescription" text='<%# DataBinder.Eval(Container.DataItem, "listGroupName") %>' CommandName=cmdEdit Font-Underline=True CssClass="normal" Width=260 Runat=server />
				</ItemTemplate>
			</asp:TemplateColumn>
			<asp:TemplateColumn>
				<ItemTemplate>
					&nbsp;
					<asp:hyperlink ID="Linkbutton27" text="Edit Items" NavigateUrl='<%# "~/default.aspx?pageId=33&id=" + DataBinder.Eval(Container.DataItem, "id") %>' CommandName=cmdEdit Font-Underline=True CssClass="normal" Width=260 Runat=server />
				</ItemTemplate>
			</asp:TemplateColumn>
			<asp:TemplateColumn ItemStyle-Width="100">
				<ItemTemplate>
