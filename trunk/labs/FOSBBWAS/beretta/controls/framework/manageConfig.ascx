<%@ Control Language="c#" AutoEventWireup="false" Codebehind="manageConfig.ascx.cs" Inherits="sourceControl.controls.manageConfig" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
This screen allows you to maintain system settings.
<br><br>
...
<asp:Panel ID=panelNew Visible=False Runat=server>
	...
	<table width=500>
		...
		<tr>
			<td> Key Name: </td>
			<td> &nbsp; </td>
			<td> <asp:TextBox ID=txtKeyName Runat=server Width=300></asp:TextBox></td>
		...
		<tr>
			<td> Key Value: </td>
			<td> &nbsp; </td>
			<td> <asp:TextBox ID="txtKeyValue" Runat=server Width=300></asp:TextBox></td>
	...
	<ItemStyle CssClass="even" />
				<Columns>
					...
					<asp:TemplateColumn ItemStyle-Width="50" >
						<ItemTemplate>
							<asp:Image BorderWidth=0 Runat=server ImageUrl="~/common/images/setting.gif" ID="Image1" NAME="Image1"></asp:Image>
							
						</ItemTemplate>
				
					</asp:TemplateColumn>
					
					<asp:TemplateColumn ItemStyle-Width="300" HeaderText="Key Name">
						<ItemTemplate>
						&nbsp;
							<asp:linkButton ID="lblUsername" text='<%# DataBinder.Eval(Container.DataItem, "keyName") %>' CommandName=cmdEdit Font-Underline=True CssClass="normal" Width=260 Runat=server />
						</ItemTemplate>
				
					</asp:TemplateColumn>
					
					<asp:TemplateColumn ItemStyle-Width="300" HeaderText="Key Value">
						<ItemTemplate>
							<asp:label ID="lblKeyValue" text='<%# DataBinder.Eval(Container.DataItem, "keyValue") %>' CssClass="normal" Width=260 Runat=server />
						</ItemTemplate>
