 ...
 * Date: 25/06/2005
 * Version: 1.0
 * Purpose: Manage modules screen (FRAMEWORK_moduleDefinitions)
 */
using System;
using System.Data;
...
namespace sourceControl.controls
{
	...
	/// <summary>
	///		Summary description for manageModules.
	/// </summary>
	public class manageModules : System.Web.UI.UserControl
	{
		...
		protected System.Web.UI.WebControls.TextBox txtSrc;
		...
		protected module objModule=new module();
		...
		private void selectRefreshType()
		{
			...
			{
				objDataView.RowFilter="src LIKE'" + strAlphabet + "%'";
			}
			...
			if (strSectionName != "")
			{
				...
				{
					objDataView.RowFilter=objDataView.RowFilter + " AND src LIKE'%" + strSectionName + "%'";
				}
				else
				{
					objDataView.RowFilter="src LIKE'%" + strSectionName + "%'";
				}
		...
		public void dgCommand_onClick(System.Object o, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			if (strCommandName == "cmdDelete")
			{
				...
				moduleDataAccess.delete(intItemId);
			...
			if (strCommandName =="cmdEdit")
			{
				...
				objModule.id=intItemId;
				objModule.populate();
				
				panelNew_reset();
				panelNew.Visible=true;

				txtSrc.Text="" + objModule.src;
				txtDescription.Text="" + objModule.description;

				ViewState["id"]="" + objModule.id.ToString();
		...
		private void cmdAdd_Click(object sender, System.EventArgs e)
		{
			...
			{
				objModule.id=System.Convert.ToInt32(ViewState["id"]);
				objModule.populate();
			}

			objModule.src="" + txtSrc.Text;
			objModule.description="" + txtDescription.Text;
