 ...
 * Date: 25/06/2005
 * Version: 1.0
 * Purpose: Manage hosts allow (to allow user to restrict access by ip)
 */
using System;
using System.Data;
...
namespace sourceControl.controls
{
	...
	/// <summary>
	///		Summary description for manageHosts.
	/// </summary>
	public class manageHosts : System.Web.UI.UserControl
	{
		...
		protected hostsAllow objHostsAllow= new hostsAllow();
		...
		{
			DataSet objDataSet =new DataSet();
			objDataSet = hostsAllowDataAccess.getAll();
		...
		public void dgCommand_onClick(System.Object o, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			if (strCommandName == "cmdDelete")
			{
				...
				hostsAllowDataAccess.delete(intItemId);
			...
			if (strCommandName =="cmdEdit")
			{
				...
				objHostsAllow.id=intItemId;
				objHostsAllow.populate();
				
				panelNew_reset();
				panelNew.Visible=true;

				txtDescription.Text="" + objHostsAllow.description;
				txtIp.Text="" + objHostsAllow.ip;

				ViewState["id"]="" + objHostsAllow.id.ToString();
		...
		private void cmdAdd_Click(object sender, System.EventArgs e)
		{
			...
			{
				objHostsAllow.id=System.Convert.ToInt32(ViewState["id"]);
				objHostsAllow.populate();
			}

			
			objHostsAllow.ip="" + txtIp.Text;
			objHostsAllow.description="" + txtDescription.Text;
