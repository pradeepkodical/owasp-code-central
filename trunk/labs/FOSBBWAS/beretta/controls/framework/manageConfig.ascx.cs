 ...
 * Date: 25/06/2005
 * Version: 1.0
 * Purpose: Manage System config settings
 */
using System;
using System.Data;
...
namespace sourceControl.controls
{
	...
	/// <summary>
	///		Summary description for manageConfig.
	/// </summary>
	public class manageConfig : System.Web.UI.UserControl
	{
		...
		protected System.Web.UI.WebControls.TextBox txtKeyName;
		protected System.Web.UI.WebControls.TextBox txtKeyValue;
		...
		private void selectRefreshType()
		{
			...
			{
				objDataView.RowFilter="keyname LIKE'" + strAlphabet + "%'";
			}
			...
			if (strSectionName != "")
			{
				...
				{
					objDataView.RowFilter=objDataView.RowFilter + " AND keyname LIKE'%" + strSectionName + "%'";
				}
				else
				{
					objDataView.RowFilter="keyname LIKE'%" + strSectionName + "%'";
				}
		...
		{
			DataSet objDataSet =new DataSet();
			objDataSet = keyDataAccess.getAll(); 
		...
		public void dgCommand_onClick(System.Object o, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			if (strCommandName == "cmdDelete")
			{
				...
				keyDataAccess.delete(intItemId);
			...
			if (strCommandName =="cmdEdit")
			{
				...
				txtKeyName.Text="" + objKey.keyName;
				txtKeyValue.Text="" + objKey.keyValue;
				txtDescription.Text="" + objKey.description;

				ViewState["id"]="" + objKey.id.ToString();
