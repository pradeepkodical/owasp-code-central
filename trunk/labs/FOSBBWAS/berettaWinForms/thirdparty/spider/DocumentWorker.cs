	...
	public class DocumentWorker
	{
		...
		private string GetPage()
		{
			...
			try
			{
				...
				strUrl="" + m_uri.AbsoluteUri.ToString();
				
				
				intDotPos=strUrl.LastIndexOf(".");
				
				if (intDotPos>0)
				{
					strExtension=strUrl.Substring(intDotPos).ToUpper();
					...
					else if(strExtension==".ASP")
					{
						bolMatchType=true;
					}
					else if(strExtension==".ASPX")
					{
						bolMatchType=true;
					}
					else if(strExtension==".CFM")
					{
						bolMatchType=true;
					}
					else if(strExtension==".PL")
					{
						bolMatchType=true;
					}
					else if(strExtension==".SHTML")
					{
						bolMatchType=true;
					}
					else if(strExtension==".SHTM")
					{
						bolMatchType=true;
					}
					else if(strExtension==".CFML")
					{
						bolMatchType=true;
					}
					else if(strExtension==".PHP3")
					{
						bolMatchType=true;
					}
					else if(strExtension==".PHP4")
					{
						bolMatchType=true;
					}
					else if(strExtension==".JSP")
					{
						bolMatchType=true;
					}
					else if(strExtension==".JSF")
					{
						bolMatchType=true;
					}
					else if(strExtension==".HTA")
					{
						bolMatchType=true;
					}
				...
				if (bolMatchType==true)
				{
					...
					string strPath = rootPath + "tmpUrl.txt";
					...
					//Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(System.Configuration.ConfigurationSettings.AppSettings.Get("databaseConnection"), "WEBSCANNER_urls_add", m_sessionId, strUrl, "Spidered URL", 0);
				}
