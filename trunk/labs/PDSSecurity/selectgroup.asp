...
<INPUT type="hidden" name=FromTbl		value="SecGroup">
<INPUT type="hidden" name=FieldCSV		value="ID,GroupName">
<INPUT type="hidden" name=PermFilter		value="">
<INPUT type="hidden" name=OrderCSV		value="GroupName;ASC">
<INPUT type="hidden" name=TitleCSV		value="ID,Group Name">
...
<INPUT type="hidden" name=LinkCSV		value="0,1,../editgroup.asp">
