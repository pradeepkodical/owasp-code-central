...
<INPUT type="hidden" name=FromTbl		value="SecUser">
<INPUT type="hidden" name=FieldCSV		value="ID,UserName">
<INPUT type="hidden" name=PermFilter	value="">
<INPUT type="hidden" name=OrderCSV		value="UserName;ASC">
<INPUT type="hidden" name=TitleCSV		value="ID,User Name">
...
<INPUT type="hidden" name=LinkCSV		value="0,1,../edituser.asp">
