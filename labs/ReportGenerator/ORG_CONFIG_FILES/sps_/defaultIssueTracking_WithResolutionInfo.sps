...
<structure version="3" schemafile="projectXsd.xsd" workingxmlfile="U:\_consolidatedReports\Australia.xml" templatexmlfile="" xsltversion="2" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8">
	...
	<template>
		...
		<children>
			<newline/>
			<text fixtext="ISSUE TRACKING (with Resolution Info)">
																																			...
																																			<tablerow>
																																				<children>
																																						...
																																						<children>
																																							<template>
																																								...
																																								<children>
																																									<select ownvalue="1">
																																										<properties size="0"/>
																																										<selectoption description="Not Reported" value="Not Reported"/>
																																										<selectoption description="Reported" value="Reported"/>
																																										<selectoption description="Temp. Managed" value="Temp. Managed"/>
																																					...
																																					<tablecol>
																																						...
																																						<properties align="center" bgcolor="F0F0F0"/>
																																						<children>
																																							<text fixtext="open:">
																																								<styles font-family="Verdana" font-size="xx-small" font-weight="bold"/>
																																							</text>
