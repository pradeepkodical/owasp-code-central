...
<structure version="3" schemafile="V:\1. Application (i.e. run VulnReport from the network)\v0.75\VulnReport_Files\xsd\projectXsd.xsd" workingxmlfile="U:\_consolidatedReports\Australia.xml" templatexmlfile="" xsltversion="2" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8">
