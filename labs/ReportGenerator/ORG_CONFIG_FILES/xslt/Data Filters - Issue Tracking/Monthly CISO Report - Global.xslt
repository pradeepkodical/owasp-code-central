	...
	<xsl:template match="/">
		<MonthlyStats xmlns:n1="vuln_report">
			...
			<AllProjects_Reported>
				...
				<TotalCount><xsl:value-of select="count(//n1:Project/n1:Targets/n1:Target/n1:Findings/n1:Finding[@IncludeInReport='true']/n1:Resolution[@Status!='Not Reported'])" /></TotalCount>
			</AllProjects_Reported>
			<AllProjects>
				...
				<TotalCount><xsl:value-of select="count(//n1:Project/n1:Targets/n1:Target/n1:Findings/n1:Finding[@IncludeInReport='true']/n1:Resolution[@Status!='Closed'])" /></TotalCount>
			</AllProjects>
			<ProjectByRegion>
				<Region name="EU">
					<Reported>
