...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:n1="vuln_report">
	...
	<xsl:template match="/">
		<!-- <xsl:variable name="query" select="/n1:ConsolidatedProjects/n1:Project[n1:Metadata/n1:project_name = 'Internet Proxy Voting System'] |
											/n1:ConsolidatedProjects/n1:Project[n1:Metadata/n1:project_name = 'IPoP - Netherlands']" /> -->
		<xsl:variable name="query" select="/n1:ConsolidatedProjects/n1:Project[n1:Metadata/n1:Region = 'NL'][n1:Metadata/n1:TestType != 'ISA']"/>
		<MonthlyStats>
			<ReportTitle>TSA Remediation</ReportTitle>
			<ReportSubTitle>RISO Report</ReportSubTitle>
			<ReportRegion>Netherlands</ReportRegion>
