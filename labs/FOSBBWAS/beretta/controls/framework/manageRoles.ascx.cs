 ...
 * Date: 28/06/2005
 * Version: 1.0
 * Purpose: Manage FRAMEWORK_roles
 */
using System;
using System.Data;
...
namespace sourceControl.controls
{
	...
	/// </summary>
	public class manageRoles : System.Web.UI.UserControl
	{
		...
		protected role objRole= new role();
		...
		private void selectRefreshType()
		{
			...
			{
				objDataView.RowFilter="roleName LIKE'" + strAlphabet + "%'";
			}
			...
			if (strSectionName != "")
			{
				...
				{
					objDataView.RowFilter=objDataView.RowFilter + " AND roleName LIKE'%" + strSectionName + "%'";
				}
				else
				{
					objDataView.RowFilter="roleName LIKE'%" + strSectionName + "%'";
				}
		...
		public void dgCommand_onClick(System.Object o, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			if (strCommandName =="cmdEdit")
			{
				...
				ViewState["id"]="" + objRole.id.ToString();
		...
		private void cmdAdd_Click(object sender, System.EventArgs e)
		{
			...
			{
				objRole.id=System.Convert.ToInt32(ViewState["id"]);
				objRole.populate();
			}
