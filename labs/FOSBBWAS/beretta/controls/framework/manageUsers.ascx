<%@ Control Language="c#" AutoEventWireup="false" Codebehind="manageUsers.ascx.cs" Inherits="sourceControl.controls.manageUsers" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<br>
<h1>Manage Users</h1>
<br>

	This screen allows you to create and maintain users.

	<br><br>
	
	<asp:HyperLink Runat="server" NavigateUrl="~/default.aspx?pageId=36&amp;userId=0" id="HyperLink1">New User</asp:HyperLink>
	<br>
	<br>
	...
	<asp:datagrid id="dbgrid" runat="server" Width="600" OnItemCommand="dgCommand_onClick" PagerStyle-Mode="NumericPages"
		...
		<Columns>
			...
			<asp:TemplateColumn ItemStyle-Width="50">
				<ItemTemplate>
					<asp:Image BorderWidth="0" Runat="server" ImageUrl="~/common/images/user.gif"></asp:Image>
				</ItemTemplate>
			</asp:TemplateColumn>
			<asp:TemplateColumn ItemStyle-Width="300" HeaderText="Username">
				<ItemTemplate>
					<asp:hyperlink ID="lblUsername" text='<%# DataBinder.Eval(Container.DataItem, "username") %>' NavigateUrl='<%# "~/default.aspx?pageId=36&userId=" + DataBinder.Eval(Container.DataItem, "id") %>' CssClass="normal" Width=260 Runat=server />
				</ItemTemplate>
			</asp:TemplateColumn>
