namespace beretta.Web
{
	...
	/// </summary>
	public class managePasswords : System.Web.UI.UserControl
	{
		...
		protected passwordDataAccess objPasswordDataAccess=new passwordDataAccess();
		...
		private void selectRefreshType()
		{
			...
			{
				objDataView.RowFilter="password LIKE'" + strAlphabet + "%'";
			}
			...
			if (strSectionName != "")
			{
				...
				{
					objDataView.RowFilter=objDataView.RowFilter + " AND password LIKE'%" + strSectionName + "%'";
				}
				else
				{
					objDataView.RowFilter="password LIKE'%" + strSectionName + "%'";
				}
		...
		{
			DataSet objDataSet =new DataSet();
			objDataSet = objPasswordDataAccess.getAll();
		...
		public void dgCommand_onClick(System.Object o, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			if (strCommandName == "cmdDelete")
			{
				...
				objPasswordDataAccess.delete(intItemId);
			...
			if (strCommandName=="cmdAdd")
			{
				...
				if (txtValue.Text.Trim() != "" && txtOrder.Text.Trim() != "")
				{
					...
					objPasswordDataAccess.add(txtValue.Text, System.Convert.ToInt32(txtOrder.Text));
			...
			if (strCommandName == "cmdUpdate")
			{
				...
				objPasswordDataAccess.update(intItemId, txtValue.Text, System.Convert.ToInt32(txtOrder.Text));
