...
namespace beretta.Objects
{
	...
	public class formSubmitter
	{
		...
		private string getUrlForPage(string strUrl)
		{
			...
			{
				string strTmpUrl="";
				string strRegularExpression=@"<form\s[a-zA-Z0-9""=\?\s.]+>";
				string strActionRegularExpression=@"action=[""']?[a-zA-Z0-9.?]+";
		...
		private string getViewStateForPage(string strUrl)
		{
			try
			{
				string strViewState="";
				string strRawPage="";
				string strRegularExpression=@"<input type=""hidden"" name=""__VIEWSTATE"" value=""[a-zA-Z0-9/+]+""";
