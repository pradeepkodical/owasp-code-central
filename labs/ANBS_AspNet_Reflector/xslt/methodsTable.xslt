...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="data:arrayReflectedData">
		<table width="400" style="border:1 ;border-color: #000000; border-style: solid;background-color:#FFFFFF" cellspacing="0" bgcolor="White">
			<tr>
				<td bgcolor="#C0C0C0" class="td_LHS_Menu"> Invoke Method Results</td>
			</tr>
			<tr>
				<td><div id="InvokeMethodResult">...</div></td>
			</tr>			
		</table>		
		<hr/>				
		  <table width="400" style="border:1 ;border-color: #000000; border-style: solid;background-color:#FFFFFF" cellspacing="0" bgcolor="White">
		  <tr>
				<td bgcolor="#C0C0C0" class="td_LHS_Menu">Methods Available</td>
			</tr>
	...
	<xsl:template match="data:anyType">
		<tr>
			<td class="td_verySmall_font">
					...
					(
						<a>
							<xsl:attribute name="href">Javascript:invokeMethod(':<xsl:value-of select="../../data:groupTypeOfReflectedData"/>;','<xsl:value-of select="."/>','<xsl:value-of select="../../data:typeOfReflectedData"/>','invokeMethod','methodInvokeResult');</xsl:attribute>
							invoke
						</a>
					)
					-->
