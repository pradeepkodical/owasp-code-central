...
%>	
		...
		<body>
		 ...
		 <H2>WMI List Logical Disks</H2>	
		 
		 <blockquote>
		   <p><b>Description:</b> this test checks to see if it is possible to 
           use WMI to list the current Logical Disks</p>
		 </blockquote>
		 <hr>	
		 <b>Test results:</b>
		 <hr>
...
' General 
	...
	public Function Run_test(mode)
		...
		dim WMI_function = "Win32_LogicalDisk"		
		dim Fields_to_load = "Name"
		dim success_description = " Using WMI's " + WMI_function+ " It was possible to list the existent logical Disks"
