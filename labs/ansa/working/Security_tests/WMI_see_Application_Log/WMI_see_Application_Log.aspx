...
%>	
		...
		<%	End_if_in_safe_mode %>
		 ...
		 <H2>WMI List Application Event Log Entries</H2>	
		 
		 <blockquote>
		   <p><b>Description:</b> this test checks to see if it is possible to 
           use WMI to list entries from the Application Event Log</p>
		 </blockquote>
		 <hr>	
		 <b>Test results:</b>
		 <hr>
...
' General 
	...
	public Function Run_test(mode)
		...
		dim success_description = " Using WMI's " + WMI_function+ " It was possible to list the current Application event log entries"
